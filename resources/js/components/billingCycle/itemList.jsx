    ...
    renderRows() {
        ...
        return list.map((item, index) => (
            <tr key={index}>
                ...
                <td>
                    <button type='button' className='btn btn-success' onClick={() => this.add(index + 1)}><FaPlus /></button>
                    <button type='button' className='btn btn-warning' onClick={() => this.add(index + 1, item)}><FaRegClone /></button>
                    <button type='button' className='btn btn-danger' onClick={() => this.remove(index)}><FaRegTrashAlt /></button>
                </td>
            </tr>
        ))
    }
