...
// import { initCredit } from '../../store'
// // import CreditList from './creditList';

// class CreditFrom extends Component {
...
// CreditFrom = reduxForm({form: 'FormCredit', destroyOnUnmount: false})(CreditFrom)
// const selector = formValueSelector('FormCredit')
// const mapStateToProps = state => ({credits: selector(state, 'credits')})
// const mapDispachToProps = dispatch => bindActionCreators({initCredit}, dispatch)
// export default connect(mapStateToProps, mapDispachToProps)(CreditFrom)
